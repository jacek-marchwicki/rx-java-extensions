...
dependencies {
    ...
    compile 'com.github.jacek-marchwicki.rx-java-extensions:rx-extensions:<look-on-release-tab>'
    compile 'com.github.jacek-marchwicki.rx-java-extensions:rx-android-extensions:<look-on-release-tab>'
}
```
